...
const META: Record<Metric, { title: string; subtitle: string; type?: "income" | "expense" }> = {
  income: {
    title: "Топ орлогын эх үүсвэр",
    subtitle: "Танд хамгийн их төлсөн харьцагч бүрийн задаргаа",
    type: "income",
  },
  expense: {
    title: "Топ зарлагын чиглэл",
    subtitle: "Хамгийн их зарцуулсан харьцагч бүрийн задаргаа",
    type: "expense",
  },
  largest: {
    title: "Хамгийн өндөр дүнтэй гүйлгээ",
    subtitle: "Нэг удаагийн томоохон гүйлгээтэй харьцагчид",
  },
  frequent: {
    title: "Хамгийн их давтамжтай харьцагч",
    subtitle: "Гүйлгээний тоогоор эрэмбэлсэн харьцагч бүрийн задаргаа",
  },
};
...
export default function InsightsDetailClient({ metric, year, month }: Props) {
  ...
  const fetchList = useCallback(async () => {
    ...
    try {
      ...
      // Дата шинэчлэгдвэл кэшийг хоослоно (дэлгэсэн зүйл байвал дахин татагдана).
      setTxCache({});
    } finally {
      setLoading(false);
    }
    ...
    <AppShell>
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          {meta.subtitle} — харьцагч дээр дарж тухайн гүйлгээнүүдийг харна уу
        </p>
      </div>
