...
### Added — POS / такси автомат ангилал (keyword rules)
- **POS гүйлгээ → «Худалдан авалт»**: шинээр оруулсан хуулгын `POS`/`pos` утгатай
  зарлагыг автоматаар «Худалдан авалт» ангилалд оноодог болсон. `\bpos(\b|\d)`
  boundary ашиглан `deposit`, `position`, `purpose` доторх "pos"-той андуурахгүй.
- **такси / taxi → «Тээвэр»**: `такси`/`taxi` утгатай гүйлгээг автоматаар «Тээвэр»
  ангилалд оноодог болсон.
- **taxi vs tax андуурлыг зассан** (гол засвар): өмнө нь `tax` дүрэм нь `taxi`
  доторх "tax"-ийг барьж авч таксины гүйлгээг «Татвар» руу буруу оруулдаг байсан.
  Одоо (а) такси дүрмийг татвар дүрмээс өмнө байрлуулж, (б) татварын дүрмийг
  `\btax\b` word-boundary болгож "taxi"-г бүрэн хассан.
- **«Худалдан авалт» ангиллыг каталогт нэмсэн** (personal + business зарлага,
  `ShoppingBag` икон) — UI-д зөв икон/өнгөөр харагдаж, ангилал сонгох цэсэнд гарна.
- Файлууд: `apps/web/lib/ai/categorize.ts`, `apps/web/lib/categories.ts`,
  `apps/web/lib/category-icons.ts`.
- ⚠ Зөвхөн шинээр оруулсан хуулгад үйлчилнэ — өмнө орсон гүйлгээг backfill хийхгүй.
