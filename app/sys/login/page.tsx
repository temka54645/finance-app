    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 text-slate-100 px-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          {/* Google login: имэйлийг урьдчилан шалгаж, admin role-той бол л OAuth flow эхэлнэ */}
          <AdminGoogleForm />
        </form>
...
function AdminGoogleForm() {
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const formData = new FormData(e.currentTarget);
    startTransition(async () => {
      const res = await adminGoogleSigninAction(formData);
      if (res.ok) {
        // Server side зөвшөөрсөн — Google OAuth flow эхлүүлнэ
        // Auth.js signIn нь client side ажиллах ёстой тул re-import
